...
const createNewTicket = async (req, res) => {
  const { user, title, client, area, platform, description } = req.body;

  // Confirm data
  if (!user || !title || !client || !area || !platform || !description) {
...
const updateTicket = async (req, res) => {
  const { id, user, title, client, area, platform, description, completed } =
    req.body;
